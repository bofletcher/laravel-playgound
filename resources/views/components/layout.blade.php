                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <x-nav-link href="/" id="1" :active="request()->is('/')">Home</x-nav-link>
                                ...
                                <div>
                                    <button type="button"
                                        ...
                                        <img class="size-8 rounded-full"
                                            src="{{ asset('images/bruce_wayne_400x400.jpg') }}" alt="Bruce Wayne">
                                    </button>
                                </div>
                            </div>
                        </div>
            ...
            <div class="md:hidden" id="mobile-menu">
                ...
                <div class="border-t border-gray-700 pb-3 pt-4">
                    <div class="flex items-center px-5">
                        <div class="shrink-0">
                            <img class="size-8 rounded-full" src="{{ asset('images/bruce_wayne_400x400.jpg') }}"
                                alt="Bruce Wayne">
                        </div>
                        <div class="ml-3">
                            <div class="text-base/5 font-medium text-white">Bruce Wayne</div>
